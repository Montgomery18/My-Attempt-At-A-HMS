...
namespace Hospital_Management_System
{
    public partial class MainMenuDoctor : Form
    {
        ...
        private void picButtonLabTestResults_Click(object sender, EventArgs e)
        {
            LabTestResults labTestResults = new LabTestResults(accessLevel);
            Hide();
            labTestResults.ShowDialog();
            if (labTestResults.getLogoutState() == true)
            {
                Close();
            }
            Show();
